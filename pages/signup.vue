                ...
                <div class="card card-signin my-5">
                    ...
                    <form class="form-signin" @submit.prevent="signup">
                        <div class="form-label-group">
                            <input v-model.trim="form.name" type="text" id="inputName" class="form-control" placeholder="Full Name" required autofocus>
                            <label for="inputName">Full Name</label>
                        </div>
                        <div class="form-label-group">
                            <input v-model.trim="form.email" type="email" id="inputEmail" class="form-control" placeholder="Email address" required>
